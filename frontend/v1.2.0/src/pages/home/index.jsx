            ...
            <div className="section-content" style={{width:sectionWidth}}>
              ...
              <div className="section-left">
                ...
                <div className="column-1" style={{marginRight:scalar}}>
                  <div onClick={() => this.href("/pandora/note")} style={{width:scalar*35,height:scalar*17,marginBottom:scalar,backgroundColor:'#CC99CC',backgroundImage:`url('${process.env.PUBLIC_URL}/picture/home/signboard.svg')`}} className="inithover hover1">技术专题</div>
                  <div className="row-2" style={{width:scalar*35,marginBottom:scalar,height:scalar*17}}>
                    <div onClick={() => this.href("/pandora/news")} style={{width:scalar*17,marginRight:scalar,height:scalar*17,backgroundColor:'#FF9966',backgroundImage:`url('${process.env.PUBLIC_URL}/picture/home/notice.svg')`}} className="inithover hover1">消息动态</div>
                ...
                <div className="column-3">
                  ...
                  <div onClick={() => this.href("/pandora/plan")} style={{width:scalar*35,height:scalar*17,marginBottom:scalar,backgroundColor:'#CCCC99',backgroundImage:`url('${process.env.PUBLIC_URL}/picture/home/calendar.svg')`}} className="inithover hover1">计划安排</div>
              ...
              <div className="section-right">
                ...
                <div onClick={() => this.href("/pandora/me")} style={{width:scalar*35,height:scalar*17,marginBottom:scalar,backgroundColor:'#CC6699',backgroundImage:`url('${process.env.PUBLIC_URL}/picture/home/prompt.svg')`}} className="inithover hover1">了解更多</div>
