                                                    ...
                                                    <div className="news-footer">
                                                        <ul>
                                                            <li className="pre-li">
                                                                <span>上一篇</span>
                                                                {
                                                                    !(isEmptyObject(datas.pre)) ? <a href={`/pandora/news/${datas.pre.id}`}>{datas.pre.topic}</a> : <a href="#base-content">已是第一篇了</a>
                                                                }
                                                            </li>
                                                            <li className="next-li">
                                                                <span>下一篇</span>
                                                                {
                                                                    !(isEmptyObject(datas.next)) ? <a href={`/pandora/news/${datas.next.id}`}>{datas.next.topic}</a> :
