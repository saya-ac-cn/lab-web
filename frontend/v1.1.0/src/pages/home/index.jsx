...
import frontendMenuListV1 from '../../config/menuConfig'
import {Col, Row, Carousel, Button, AutoComplete} from "antd";
...
class Home extends Component {
    ...
    onSearch = async (searchText) => {
        if (!!searchText){
            ...
            let dataSource = s.reduce((pre, item) => {
              pre.push({ value: item })
              return pre
            },[])
            this.setState({
                            ...
                            <Col span={20} offset={2} className="search-div">
                                ...
                                <div className="search-line2">
                                    <AutoComplete
                                        ...
                                        placeholder="请输入内容"
                                    />
                                    <Button className="search-button" onClick={this.goSearch}><SearchOutlined /></Button>
                                </div>
                            </Col>
                        </Row>
                    </section>
                    <footer className="this-copright">
                        <Row gutter={20} style={{width: '100%'}}>
                            <Col span={20} offset={2}>
                                Copyright &copy; 2016-{copyrightDate} &nbsp; Saya.ac.cn-极客印记 版权所有<br/>国家工信部域名备案信息：<a href="https://beian.miit.gov.cn/" rel="noopener noreferrer" target='_blank'>蜀ICP备2021013893号-1</a>
                            </Col>
                        </Row>
                    </footer>
                </div>
