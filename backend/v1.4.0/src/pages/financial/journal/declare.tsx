...
import {paymentMeansListApi, abstractsApi, addJournalApi, monetaryListApi,getToken} from "@/http/api";
...
const JournalDeclare = (props,ref) => {
  ...
  const handleApply = async () => {
    ...
    const {err, result} = await addJournalApi(param);
    if (err){
      console.error('流水申报异常异常:',err)
