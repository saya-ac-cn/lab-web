        ...
        return (
            <section>
                <Form layout="inline" style={{marginBottom: '1em'}}>
                    <Form.Item label='出入方式' name='viewAddFlog' initialValue={'1'} rules={[{required: true, message: '请选择出入方式'}]}>
                    ...
                    <Form.Item label='金额' name='viewAddCurrencyNumber' initialValue={0} rules={[{required: true, message: '请填写金额'},{max: 12, message: '长度在 12个字符以内'}]}>
                      <Input prefix={<Icon type="pay-circle"/>} type="number" placeholder="金额"/>
                    </Form.Item>
                    <Form.Item label='摘要' name='viewAddCurrencyDetails' rules={[{required: true, message: '请填写摘要'},{min: 2, message: '长度在 2 到 20 个字符'},{max: 20, message: '长度在 2 到 20 个字符'} ]}>
                      <Input prefix={<Icon type="account-book"/>} type="text" placeholder="说明"/>
                    </Form.Item>
                    <Form.Item>
                ...
                <Form layout="inline" style={{marginBottom: '1em'}}>
                    <Form.Item label='出入方式' name='viewEditFlog' initialValue={editItem.flog + ''} rules={[{required: true, message: '请选择出入方式'}]}>
                      <Select suffixIcon={<Icon type="select"/>} style={{width: 200}}>
                        <Option value="1">存入</Option>
                        <Option value="2">取出</Option>
                      </Select>
                    </Form.Item>
                    <Form.Item label='金额' name='viewEditCurrencyNumber' initialValue={editItem.currencyNumber} rules={[{required: true, message: '请填写金额'},{max: 12, message: '长度在 12个字符以内'}]}>
                      <Input prefix={<Icon type="pay-circle"/>} type="number" placeholder="金额"/>
                    </Form.Item>
                    <Form.Item label='摘要' name='viewEditCurrencyDetails' initialValue={editItem.currencyDetails} rules={[{required: true, message: '请填写摘要'},{min: 2, message: '长度在 2 到 20 个字符'},{max: 20, message: '长度在 2 到 20 个字符'}]}>
                      <Input prefix={<Icon type="account-book"/>} type="text" placeholder="说明"/>
                    </Form.Item>
                    <Form.Item>
